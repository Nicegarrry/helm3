...
- [Brief](docs/brief.md) and [original human design](docs/design-source.md)
...
The GitHub repository is private. The root bootstrap contains documents and preparation tooling only. Product changes use isolated worktrees and PRs after explicit approval; read [AGENTS.md](AGENTS.md) before starting.
