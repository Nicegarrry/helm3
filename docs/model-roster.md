...
| --- | --- | --- | --- |
| NVIDIA Nemotron 3 Ultra via OpenRouter / Nvidia `:free` | Free | Initial synthetic API response: 44 tokens, US$0; native qualification tracked in #132 | Public/synthetic-only candidate. Provider logs use for security/product improvement. No coding/review tier awarded by connectivity alone. |
