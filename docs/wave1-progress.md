...
First-wave authority is recorded in [APPROVAL #2](https://github.com/Nicegarrry/helm3/issues/2#issuecomment-5671903235) and [docs/wave1-authority.md](wave1-authority.md). It authorises supervised foundation work and reviewed PR integration in this repository, with at most three workers plus coordinator. It does not authorise purchases, top-ups, incremental paid API fallback, an unattended Helm run lease, provider credentials or predecessor access.
