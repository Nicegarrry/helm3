...
[ACCESS #5](https://github.com/Nicegarrry/helm3/issues/5) remains open. [PR #37](https://github.com/Nicegarrry/helm3/pull/37) provides provider-free Codex SDK 0.154.0 evidence: local start/resume/run/streaming and child exit after AbortSignal. A later read-only status check observed existing Codex ChatGPT and Claude first-party subscription sessions, while Pi's local `openai-codex` and Anthropic routes reported `credentials_not_configured`. No live SDK probe ran. Those observations do not prove a model entitlement, provider cancellation, quota bound, or cost; Pi authentication remains unresolved.

[KERNEL #6](https://github.com/Nicegarrry/helm3/issues/6) and [JOURNAL #31](https://github.com/Nicegarrry/helm3/issues/31) are closed at library-only acceptance. [PR #41](https://github.com/Nicegarrry/helm3/pull/41) provides immutable commands, append-only events/attempts, trusted execution, separate ownership/autonomy checks, durable refusals and unknown-effect recovery. [PR #40](https://github.com/Nicegarrry/helm3/pull/40) provides the raw artifact journal and rebuildable SQLite index. [PR #42](https://github.com/Nicegarrry/helm3/pull/42) supplies their provider-free same-SQLite integration oracle. Native producer wiring remains later work.
