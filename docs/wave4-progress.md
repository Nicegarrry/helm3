...
A separately bounded paid peer attempt (`pi-wave10-terminal-peer-a01530d4-ebba-4176-949f-6b9aa5560f9d`, OpenCodeGo `kimi-k2.7-code`) made one request and ended **unknown** at approximately `2026-09-15T20:14:26Z` after 120.064 seconds, consistent with the local 120-second deadline; the upstream cause remains unknown. Its terminal envelope was empty with an assistant stop error. A reasoning prefix is not a result. It produced no verified WorkerResult, findings or acceptance evidence and was not retried. A subsequent native fork remains in progress and is not accepted evidence. The full **US$1.34742016** reservation remains held; the combined guard is **US$5.42051699 of US$10** across four unknown reservations plus **US$0.03083635** settled nominal accounting. Actual incremental billing and provider headroom remain unknown; zero SDK usage is not proof of zero charge. The accepted Map update at `2026-09-15T20:21:50.176Z` succeeded with state `OPEN` and no child closures; its command and raw receipt are recorded in the sanitised receipt. User stop at `2026-09-15T22:00:00Z` remains in force.

## Wave 12 cockpit and parallel recovery receipts — 20:51–21:01 UTC, 15 September 2026

PR #95 merged at `2026-09-15T20:51:33Z` from reviewed head `ce5531d86d90a78234db1b6769e0bb00ae5cf194` as `e72187f4df98cf1feea4d45b18a4021309d987dc`; PR #96 merged at `2026-09-15T20:59:46Z` from reviewed head `46951f3f29dcde8d31f5cce5be4aec1a2049f2f6` as `addfe7c2d5144d46130d91ed2e4f1640fca7ae1c`. Both had independent Spec and Standards passes and six successful CI checks. The [sanitised receipt](evidence/wave12-parallel-cockpit-20260916.json) records exact heads, merge readbacks and limits.

The root gate bound expected and observed head `46951f3f29dcde8d31f5cce5be4aec1a2049f2f6` and passed typecheck plus **226/226 tests** from `2026-09-15T20:57:46.605Z` through `2026-09-15T20:58:39.418Z`; per-check raw evidence references are retained. The preserved provider-free parallel run recorded three native faux workers entering the barrier at `21:00:27.129Z`, `.137Z` and `.145Z`; all three were released at `2026-09-15T21:00:27.145Z`. The sanitised receipt binds their worker, attempt and session identities and preserves the private operational state. Outcomes were two terminal and one unknown, with one retained fixture reservation, three supervisor signals including one failure judgement, and exact old-epoch refusal/new-epoch admission. Close/reopen state was preserved; this makes no real-provider claim.

The accepted typed Map update completed at `2026-09-15T21:01:39.146Z` with state `OPEN` and no child closures; command/hash/raw receipt are in the sanitised receipt. No new paid API call was made. The combined guard remains **US$5.42051699 of US$10** across four unknown paid reservations; the fixture reservation is distinct, and actual billing/headroom remain unknown. PR #93 remains draft source-leaf repair, and the earlier 229-test count remains historical. The cockpit navigation exposes available facts and explicit unknowns; neither PR establishes full Brief/UI acceptance, live-provider integration, review/repair or automatic Map closure.

## Wave 13 accepted PR #93 and preserved fork fixtures — 21:06–21:15 UTC, 15 September 2026

PR #93 was accepted from exact reviewed head `95f254bca0efdf92719329c9b8ca2314fab6d6a0` and merged as `37bbf670d51833bd6129de03bdd42e38396c02d6` at `2026-09-15T21:06:59Z`. Independent Spec and Standards reviews passed, six CI checks passed, and the [sanitised receipt](evidence/wave13-preserved-forks-20260916.json) records the bounded evidence.

The actual Helm gate ran on expected and observed head `37bbf670d51833bd6129de03bdd42e38396c02d6` from `2026-09-15T21:13:23.751Z` through `2026-09-15T21:14:17.651Z`; typecheck and **232/232 tests** passed. Separate preserved native Fable and Astra local SDK fixtures each bound a distinct source and child session to a fork command, used four model requests and two workspace writes, and completed the provider-free `red → fork → child steer → green → fixture Map close` flow with driver reopen and expired-lease refusal. The model/runtime was a faux fixture shim; these results do not establish live frontier behavior, production merge automation, model change, pause/resume or full Brief acceptance.

The preserved operational state remains available in sanitized receipts. The fixture Map closes are local fixture state; as of this receipt observation at 21:15:08.315Z, no Wave 13 GitHub Map update had been performed. No new paid API call was made, and the combined guard remains **US$5.42051699 of US$10** with actual incremental billing and provider headroom unknown.

The dated [overnight checkpoint](overnight-checkpoint-20260916.md) records accepted PR #99 saved-viewer evidence, the exact 236-test gate, the preserved API/CLI/browser audit, the later typed Map update and the remaining priorities without claiming full Brief acceptance.
