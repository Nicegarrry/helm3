...
The root gate bound expected and observed head `46951f3f29dcde8d31f5cce5be4aec1a2049f2f6` and passed typecheck plus **226/226 tests** from `2026-09-15T20:57:46.605Z` through `2026-09-15T20:58:39.418Z`; per-check raw evidence references are retained. The preserved provider-free parallel run released three native faux workers at `21:00:27.129Z`, `.137Z` and `.145Z`, with two terminal outcomes and one unknown, one retained fixture reservation, three supervisor signals including one failure judgement, and exact old-epoch refusal/new-epoch admission. Close/reopen state was preserved; this makes no real-provider claim.
